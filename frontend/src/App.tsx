...
import { Guitar, Music, Upload as UploadIcon, Settings as SettingsIcon, LayoutDashboard, BookOpen } from 'lucide-react'
      ...
      <nav className="sticky top-0 z-50 bg-white/80 backdrop-blur-md border-b border-neutral-200">
        <div className="max-w-6xl mx-auto px-4 sm:px-6 md:px-8 py-4 flex items-center justify-between gap-4 flex-wrap">
          ...
          <div className="flex items-center gap-2 sm:gap-4">
            <Link to="/" className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white border border-neutral-200 hover:bg-neutral-50 text-neutral-700 font-medium transition-colors">
            ...
            <Link to="/licks" className="flex items-center gap-2 px-3 py-2 rounded-lg bg-white border border-neutral-200 hover:bg-neutral-50 text-neutral-700 font-medium transition-colors">
              ...
              <span className="hidden sm:inline">Licks</span>
            </Link>
